...
import "./Doctors.css";
import { getAllDoctors } from "../components/apiService";
  ...
  const defaultDoctorsData = [
    {
      ...
      clinicLocation: "City Hospital",
      bio: "Dr. John Doe is a cardiologist with years of experience",
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const formattedRecords = doctors.data.map((doctors, index) => ({
          id: index,
        ...
        setDoctorsData(formattedRecords);
      } catch (error) {
